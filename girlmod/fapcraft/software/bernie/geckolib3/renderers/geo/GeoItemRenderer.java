...
public abstract class GeoItemRenderer<T extends Item & IAnimatable> extends TileEntityItemStackRenderer implements IGeoRenderer<T> {
   ...
   public void render(T animatable, ItemStack itemStack) {
      ...
      AnimationEvent itemEvent = new AnimationEvent(animatable, 0.0F, 0.0F, Minecraft.func_71410_x().func_184121_ak(), false, Collections.singletonList(itemStack));
      ...
      GlStateManager.func_179137_b((double)0.5F, (double)0.5F, (double)0.5F);
