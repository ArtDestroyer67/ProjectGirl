...
public abstract class GeoReplacedEntityRenderer<T extends IAnimatable> extends Render<EntityLivingBase> implements IGeoRenderer {
   ...
   protected void applyRotations(EntityLivingBase entityLiving, float ageInTicks, float rotationYaw, float partialTicks) {
      ...
      if (entityLiving.field_70725_aQ > 0) {
         ...
         if (("Dinnerbone".equals(s) || "Grumm".equals(s)) && (!(entityLiving instanceof EntityPlayer) || ((EntityPlayer)entityLiving).func_175148_a(EnumPlayerModelParts.CAPE))) {
            GlStateManager.func_179137_b((double)0.0F, (double)(entityLiving.field_70131_O + 0.1F), (double)0.0F);
   ...
   protected void renderLeash(EntityLiving entityLivingIn, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      if (entity != null) {
         y -= (1.6 - (double)entityLivingIn.field_70131_O) * (double)0.5F;
         Tessellator tessellator = Tessellator.func_178181_a();
         BufferBuilder bufferbuilder = tessellator.func_178180_c();
         double d0 = this.interpolateValue((double)entity.field_70126_B, (double)entity.field_70177_z, (double)(partialTicks * 0.5F)) * (double)((float)Math.PI / 180F);
         double d1 = this.interpolateValue((double)entity.field_70127_C, (double)entity.field_70125_A, (double)(partialTicks * 0.5F)) * (double)((float)Math.PI / 180F);
         ...
         double d6 = this.interpolateValue(entity.field_70169_q, entity.field_70165_t, (double)partialTicks) - d2 * 0.7 - d3 * (double)0.5F * d5;
         double d7 = this.interpolateValue(entity.field_70167_r + (double)entity.func_70047_e() * 0.7, entity.field_70163_u + (double)entity.func_70047_e() * 0.7, (double)partialTicks) - d4 * (double)0.5F - (double)0.25F;
         double d8 = this.interpolateValue(entity.field_70166_s, entity.field_70161_v, (double)partialTicks) - d3 * 0.7 + d2 * (double)0.5F * d5;
         double d9 = this.interpolateValue((double)entityLivingIn.field_70760_ar, (double)entityLivingIn.field_70761_aq, (double)partialTicks) * (double)((float)Math.PI / 180F) + (Math.PI / 2D);
         ...
         for(int j = 0; j <= 24; ++j) {
            ...
            bufferbuilder.func_181662_b(x + d13 * (double)f3 + (double)0.0F, y + d14 * (double)(f3 * f3 + f3) * (double)0.5F + (double)((24.0F - (float)j) / 18.0F + 0.125F), z + d15 * (double)f3).func_181666_a(f, f1, f2, 1.0F).func_181675_d();
            bufferbuilder.func_181662_b(x + d13 * (double)f3 + 0.025, y + d14 * (double)(f3 * f3 + f3) * (double)0.5F + (double)((24.0F - (float)j) / 18.0F + 0.125F) + 0.025, z + d15 * (double)f3).func_181666_a(f, f1, f2, 1.0F).func_181675_d();
         }
         ...
         for(int k = 0; k <= 24; ++k) {
            ...
            bufferbuilder.func_181662_b(x + d13 * (double)f7 + (double)0.0F, y + d14 * (double)(f7 * f7 + f7) * (double)0.5F + (double)((24.0F - (float)k) / 18.0F + 0.125F) + 0.025, z + d15 * (double)f7).func_181666_a(f4, f5, f6, 1.0F).func_181675_d();
            bufferbuilder.func_181662_b(x + d13 * (double)f7 + 0.025, y + d14 * (double)(f7 * f7 + f7) * (double)0.5F + (double)((24.0F - (float)k) / 18.0F + 0.125F), z + d15 * (double)f7 + 0.025).func_181666_a(f4, f5, f6, 1.0F).func_181675_d();
         }
