...
public class AnimationBuilder {
   ...
   public AnimationBuilder addAnimation(String animationName) {
      this.animationList.add(new RawAnimation(animationName, (ILoopType)null));
      return this;
   }
   ...
   public AnimationBuilder addRepeatingAnimation(String animationName, int timesToRepeat) {
      ...
      for(int i = 0; i < timesToRepeat; ++i) {
         this.addAnimation(animationName, (ILoopType)ILoopType.EDefaultLoopTypes.PLAY_ONCE);
      }
   ...
   public AnimationBuilder playOnce(String animationName) {
      return this.addAnimation(animationName, (ILoopType)ILoopType.EDefaultLoopTypes.PLAY_ONCE);
   }

   public AnimationBuilder loop(String animationName) {
      return this.addAnimation(animationName, (ILoopType)ILoopType.EDefaultLoopTypes.LOOP);
   }

   public AnimationBuilder playAndHold(String animationName) {
      return this.addAnimation(animationName, (ILoopType)ILoopType.EDefaultLoopTypes.HOLD_ON_LAST_FRAME);
   }
