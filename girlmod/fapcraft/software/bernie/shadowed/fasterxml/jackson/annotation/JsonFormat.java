...
public @interface JsonFormat {
   ...
   public static class Value implements JacksonAnnotationValue<JsonFormat>, Serializable {
      ...
      public static Value forShape(Shape sh) {
         return new Value((String)null, sh, (Locale)null, (String)null, (TimeZone)null, JsonFormat.Features.empty(), (Boolean)null);
      }

      public static Value forLeniency(boolean lenient) {
         return new Value((String)null, (Shape)null, (Locale)null, (String)null, (TimeZone)null, JsonFormat.Features.empty(), lenient);
      }
