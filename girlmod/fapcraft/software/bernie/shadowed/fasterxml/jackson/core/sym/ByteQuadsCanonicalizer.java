...
public final class ByteQuadsCanonicalizer {
   ...
   public ByteQuadsCanonicalizer makeChild(int flags) {
      return new ByteQuadsCanonicalizer(this, JsonFactory.Feature.INTERN_FIELD_NAMES.enabledIn(flags), this._seed, JsonFactory.Feature.FAIL_ON_SYMBOL_HASH_OVERFLOW.enabledIn(flags), (TableInfo)this._tableInfo.get());
   }
   ...
   private void _verifyNeedForRehash() {
      if (this._count > this._hashSize >> 1) {
         ...
         if (spillCount > 1 + this._count >> 7 || (double)this._count > (double)this._hashSize * 0.8) {
