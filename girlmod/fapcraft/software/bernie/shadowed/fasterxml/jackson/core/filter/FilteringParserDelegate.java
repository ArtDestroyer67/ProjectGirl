...
public class FilteringParserDelegate extends JsonParserDelegate {
   ...
   public JsonToken nextToken() throws IOException {
      if (!this._allowMultipleMatches && this._currToken != null && this._exposedContext == null && this._currToken.isScalarValue() && !this._headContext.isStartHandled() && !this._includePath && this._itemFilter == TokenFilter.INCLUDE_ALL) {
         ...
         if (t == null) {
            ...
            switch (t.id()) {
               case 1:
                  TokenFilter var14 = this._itemFilter;
                  if (var14 == TokenFilter.INCLUDE_ALL) {
                     this._headContext = this._headContext.createChildObjectContext(var14, true);
                     return this._currToken = t;
                  }
                  ...
                  if (var14 == null) {
                     ...
                     var14 = this._headContext.checkValue(var14);
                     if (var14 == null) {
                        this.delegate.skipChildren();
                     } else {
                        if (var14 != TokenFilter.INCLUDE_ALL) {
                           var14 = var14.filterStartObject();
                        }

                        this._itemFilter = var14;
                        if (var14 == TokenFilter.INCLUDE_ALL) {
                           this._headContext = this._headContext.createChildObjectContext(var14, true);
                           return this._currToken = t;
                        }

                        this._headContext = this._headContext.createChildObjectContext(var14, false);
               ...
               case 4:
                  ...
                  TokenFilter var13 = this._headContext.getFilter();
                  if (var13 != null && var13 != TokenFilter.INCLUDE_ALL) {
                     var13.filterFinishArray();
                  }
               ...
               default:
                  ...
                  if (var16 != null) {
                     ...
                     if ((var16 == TokenFilter.INCLUDE_ALL || var16 != null && var16.includeValue(this.delegate)) && this._verifyAllowedMatches()) {
                        return this._currToken = t;
                     }
                  }
            }
         ...
         switch (t.id()) {
            ...
            default:
               ...
               if (var13 != null) {
                  ...
                  if ((var13 == TokenFilter.INCLUDE_ALL || var13 != null && var13.includeValue(this.delegate)) && this._verifyAllowedMatches()) {
                     return this._currToken = t;
                  }
               }
         }
   ...
   protected final JsonToken _nextTokenWithBuffering(TokenFilterContext buffRoot) throws IOException {
      while(true) {
         ...
         switch (t.id()) {
            case 1:
               TokenFilter var9 = this._itemFilter;
               if (var9 == TokenFilter.INCLUDE_ALL) {
                  this._headContext = this._headContext.createChildObjectContext(var9, true);
                  return t;
               }
               ...
               if (var9 == null) {
                  ...
                  var9 = this._headContext.checkValue(var9);
                  if (var9 == null) {
                     this.delegate.skipChildren();
                     break;
                  }
                  ...
                  if (var9 != TokenFilter.INCLUDE_ALL) {
                     var9 = var9.filterStartObject();
                  }

                  this._itemFilter = var9;
                  if (var9 == TokenFilter.INCLUDE_ALL) {
                     this._headContext = this._headContext.createChildObjectContext(var9, true);
                     return this._nextBuffered(buffRoot);
                  }

                  this._headContext = this._headContext.createChildObjectContext(var9, false);
               }
               break;
            case 2:
            case 4:
               TokenFilter var8 = this._headContext.getFilter();
               if (var8 != null && var8 != TokenFilter.INCLUDE_ALL) {
                  var8.filterFinishArray();
               }
            ...
            default:
               ...
               if (var11 != null) {
                  var11 = this._headContext.checkValue(var11);
                  if ((var11 == TokenFilter.INCLUDE_ALL || var11 != null && var11.includeValue(this.delegate)) && this._verifyAllowedMatches()) {
                     return this._nextBuffered(buffRoot);
                  }
               }
         }
