...
public abstract class SerializerProvider extends DatabindContext {
   ...
   public JsonSerializer<Object> getUnknownTypeSerializer(Class<?> unknownType) {
      return (JsonSerializer<Object>)(unknownType == Object.class ? this._unknownTypeSerializer : new UnknownSerializer(unknownType));
   }
   ...
   public final void defaultSerializeValue(Object value, JsonGenerator gen) throws IOException {
      if (value == null) {
         ...
         this.findTypedValueSerializer(cls, true, (BeanProperty)null).serialize(value, gen, this);
      }
