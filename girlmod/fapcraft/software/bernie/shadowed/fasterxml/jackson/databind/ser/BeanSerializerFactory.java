   ...
   protected JsonSerializer<Object> constructBeanSerializer(SerializerProvider prov, BeanDescription beanDesc) throws JsonMappingException {
      if (beanDesc.getBeanClass() == Object.class) {
         ...
         if (props == null) {
            ...
            var15 = this.removeOverlappingTypeIds(prov, beanDesc, builder, props);
         }

         prov.getAnnotationIntrospector().findAndAddVirtualProperties(config, beanDesc.getClassInfo(), (List)var15);
         if (this._factoryConfig.hasSerializerModifiers()) {
            for(BeanSerializerModifier mod : this._factoryConfig.serializerModifiers()) {
               var15 = mod.changeProperties(config, beanDesc, (List)var15);
            }
         }

         List<BeanPropertyWriter> var16 = this.filterBeanProperties(config, beanDesc, (List)var15);
         if (this._factoryConfig.hasSerializerModifiers()) {
            for(BeanSerializerModifier mod : this._factoryConfig.serializerModifiers()) {
               var16 = mod.orderProperties(config, beanDesc, var16);
            }
         }

         builder.setObjectIdWriter(this.constructObjectIdHandler(prov, beanDesc, var16));
         builder.setProperties(var16);
         ...
         if (anyGetter != null) {
            ...
            if (anySer == null) {
               anySer = MapSerializer.construct((Set)null, type, staticTyping, typeSer, (JsonSerializer)null, (JsonSerializer)null, (Object)null);
            }
         ...
         return (JsonSerializer<Object>)(ser == null && beanDesc.hasKnownClassAnnotations() ? builder.createDummy() : ser);
      }
   }
