...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable {
   ...
   public ObjectMapper enableDefaultTyping(DefaultTyping applicability, JsonTypeInfo.As includeAs) {
      if (includeAs == JsonTypeInfo.As.EXTERNAL_PROPERTY) {
         ...
         TypeResolverBuilder<?> var4 = typer.init(JsonTypeInfo.Id.CLASS, (TypeIdResolver)null);
         var4 = var4.inclusion(includeAs);
   ...
   public ObjectMapper enableDefaultTypingAsProperty(DefaultTyping applicability, String propertyName) {
      ...
      var4 = var4.typeProperty(propertyName);
      return this.setDefaultTyping(var4);
   }
   ...
   public <T> MappingIterator<T> readValues(JsonParser p, JavaType valueType) throws IOException, JsonProcessingException {
      ...
      return new MappingIterator<T>(valueType, p, ctxt, deser, false, (Object)null);
   }
