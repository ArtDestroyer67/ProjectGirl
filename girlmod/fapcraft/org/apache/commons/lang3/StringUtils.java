...
public class StringUtils {
   ...
   public static <T extends CharSequence> T defaultIfBlank(T str, T defaultStr) {
      return (T)(isBlank(str) ? defaultStr : str);
   }

   public static <T extends CharSequence> T defaultIfEmpty(T str, T defaultStr) {
      return (T)(isEmpty(str) ? defaultStr : str);
   }
   ...
   public static <T extends CharSequence> T getIfBlank(T str, Supplier<T> defaultSupplier) {
      return (T)(isBlank(str) ? (defaultSupplier == null ? null : (CharSequence)defaultSupplier.get()) : str);
   }

   public static <T extends CharSequence> T getIfEmpty(T str, Supplier<T> defaultSupplier) {
      return (T)(isEmpty(str) ? (defaultSupplier == null ? null : (CharSequence)defaultSupplier.get()) : str);
   }
