...
public class Validate {
   ...
   public static <T> T notNull(T object) {
      return (T)notNull(object, "The validated object is null");
   }

   public static <T> T notNull(T object, String message, Object... values) {
      return (T)Objects.requireNonNull(object, () -> String.format(message, values));
   }
   ...
   public static <T extends Collection<?>> T notEmpty(T collection) {
      return (T)notEmpty(collection, "The validated collection is empty");
   }
   ...
   public static <T extends Map<?, ?>> T notEmpty(T map) {
      return (T)notEmpty(map, "The validated map is empty");
   }
   ...
   public static <T extends CharSequence> T notEmpty(T chars) {
      return (T)notEmpty(chars, "The validated character sequence is empty");
   }
   ...
   public static <T extends CharSequence> T notBlank(T chars) {
      return (T)notBlank(chars, "The validated character sequence is blank");
   }
   ...
   public static <T extends Iterable<?>> T noNullElements(T iterable) {
      return (T)noNullElements(iterable, "The validated collection contains null element at index: %d");
   }
   ...
   public static <T extends Collection<?>> T validIndex(T collection, int index) {
      return (T)validIndex(collection, index, "The validated collection index is invalid: %d", index);
   }
   ...
   public static <T extends CharSequence> T validIndex(T chars, int index) {
      return (T)validIndex(chars, index, "The validated character sequence index is invalid: %d", index);
   }
