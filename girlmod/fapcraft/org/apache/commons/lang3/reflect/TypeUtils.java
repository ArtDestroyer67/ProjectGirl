...
public class TypeUtils {
      ...
      if (type == null) {
         ...
         if (fromTypeVarAssigns == null) {
            ...
            for(TypeVariable<?> var : toTypeVarAssigns.keySet()) {
               ...
               if ((toTypeArg != null || !(fromTypeArg instanceof Class)) && fromTypeArg != null && !toTypeArg.equals(fromTypeArg) && (!(toTypeArg instanceof WildcardType) || !isAssignable(fromTypeArg, toTypeArg, typeVarAssigns))) {
                  return false;
               }
            }
   ...
   private static Map<TypeVariable<?>, Type> getTypeArguments(Class<?> cls, Class<?> toClass, Map<TypeVariable<?>, Type> subtypeVarAssigns) {
      if (!isAssignable(cls, (Class)toClass)) {
         ...
         return (Map<TypeVariable<?>, Type>)(toClass.equals(cls) ? typeVarAssigns : getTypeArguments((Type)getClosestParentType(cls, toClass), toClass, typeVarAssigns));
      }
   }
   ...
   public static GenericArrayType genericArrayType(Type componentType) {
      return new GenericArrayTypeImpl((Type)Validate.notNull(componentType, "componentType is null"));
   }
