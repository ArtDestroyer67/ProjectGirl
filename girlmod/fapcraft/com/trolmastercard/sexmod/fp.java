...
public enum fp {
   ...
   private fp(int var3, boolean var4, boolean var5) {
      this.ticksPlaying = new int[]{0, 0};
      this.followUp = null;
   ...
   private fp(int var3, boolean var4, boolean var5, boolean var6) {
      this(var3, var4, var5);
      this.useBoyCam = var6;
   }

   private fp(int var3, boolean var4, boolean var5, boolean var6, boolean var7) {
      this(var3, var4, var5);
      this.useBoyCam = var6;
      this.hideNameTag = var7;
   }

   private fp(int var3, boolean var4, boolean var5, float var6, float var7, boolean var8) {
      this.ticksPlaying = new int[]{0, 0};
      this.followUp = null;
      this.transitionTick = var3;
      this.hasPlayer = var4;
   ...
   private fp(int var3, boolean var4, boolean var5, float var6, float var7, boolean var8, boolean var9) {
      this.ticksPlaying = new int[]{0, 0};
      this.followUp = null;
      this.transitionTick = var3;
      this.hasPlayer = var4;
   ...
   private fp(int var3, boolean var4, boolean var5, boolean var6, float var7, float var8, boolean var9) {
      this.ticksPlaying = new int[]{0, 0};
      this.followUp = null;
      this.transitionTick = var3;
      this.hasPlayer = var4;
   ...
   private fp(int var3, boolean var4, boolean var5, int var6, fp var7) {
      this(var3, var4, var5);
      this.length = var6;
      this.followUp = var7;
   }

   private fp(int var3, boolean var4, boolean var5, boolean var6, int var7, fp var8) {
      this(var3, var4, var5);
      this.length = var7;
      this.followUp = var8;
      this.useBoyCam = var6;
   ...
   private fp(int var3, boolean var4, boolean var5, boolean var6, int var7, fp var8, float var9, float var10, boolean var11) {
      this.ticksPlaying = new int[]{0, 0};
      this.followUp = null;
      this.transitionTick = var3;
      this.hasPlayer = var4;
   ...
   private fp(int var3, boolean var4, boolean var5, boolean var6, boolean var7, int var8, fp var9) {
      this(var3, var4, var5);
      this.length = var8;
      this.followUp = var9;
      this.useBoyCam = var7;
   ...
   public static float c(em var0, float var1) {
      return (float)(var0.getFactory().getOrCreateAnimationData(var0.func_110124_au().hashCode()).tick + (double)var1 - var0.C.tickOffset);
   }
