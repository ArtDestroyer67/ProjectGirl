...
public class hf extends Gui {
   ...
   public void a(RenderGameOverlayEvent var1) {
      ...
      this.a(p, (int)((float)var5 - 1.5F * (float)w.c + 1.0F), var4 - 70 + 3);
      this.a(p, var5 - w.c / 2 + 1, var4 - 70 + 3);
      this.a(p, var5 + w.c / 2 + 1, var4 - 70 + 3);
      float var9 = (float)b6.b((double)Math.min(1.0F, (float)(var6 - s) / 150.0F));
      ...
      this.a(1, -1.5F * (float)w.c, var10, var9, var5, var4, var8);
      this.a(2, (float)(-w.c) / 2.0F, var10, var9, var5, var4, var8);
      this.a(3, (float)w.c / 2.0F, var10, var9, var5, var4, var8);
   }
   ...
   void a(int var1, float var2, float var3, float var4, int var5, int var6, float var7) {
      ...
      this.a(w, (int)((float)var5 + var2), var6 - 70);
      GlStateManager.func_179117_G();
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, (float)Math.sin(Math.PI * (double)var8) * 0.5F);
      this.a(k, (int)((float)var5 + var2), var6 - 70);
